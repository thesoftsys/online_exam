<?php 
      ...
      $sel = "SELECT * FROM add_questions WHERE exam_id = '$eId'";
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          ...
                                          <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" onclick="chkLive(<?php echo $eId; ?>,<?php echo $row['id']; ?>)" ><i class="fa fa-trash-o"></i> </button>
                                       </td>
                                    </tr>
                  ...
                  <div class="modal-dialog">
                     <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <div class="row">
                              <div class="col-md-12">
                                 <form class="form-horizontal" action="code.php?flag=24&uid=<?php echo $row['id']; ?>" method="post">
                                 <input type="hidden" name="examid" value="<?php echo $eId; ?>">
                                    <fieldset>
                  ...
                  <div class="modal-dialog">
                     <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <div class="row">
                              <div class="col-md-12">
                                 <form class="form-horizontal" action="code.php?flag=26&delid=<?php echo $row ['id']; ?>&examid=<?php echo $eId; ?>" method="post">
                                    <fieldset>
                                       <div class="col-md-12 form-group user-form-group">
                                          <label class="control-label">Delete Questions</label>
                                          <div class="pull-right">
