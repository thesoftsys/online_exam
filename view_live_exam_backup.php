                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td>
                                          ...
                                          echo '<input type="checkbox" onchange="fun(<?php echo $row[id]; ?>)" checked data-toggle="toggle" data-on="Ready" data-off="Not Ready" data-onstyle="success" data-offstyle="danger">';
                                          
                                          }
                                          else
                                          {
                                             echo '<input type="checkbox" onchange="fun(<?php echo $row[id]; ?>)"  data-toggle="toggle" data-on="Ready" data-off="Not Ready" data-onstyle="success" data-offstyle="danger">';
                                          } ?>
