...
<head>
        ...
        <title>Online Exam Login Admin Panel</title>
            ...
            <div class="login-area">
                <div class="panel panel-bd panel-custom">
                    ...
                    <div class="panel-body">
                        <form action="code.php?flag=1" novalidate method="POST">
                            <div class="form-group">
                                <label class="control-label" >Username</label>
                                <input type="email" placeholder="example@gmail.com"  required=""  name="email" id="username" class="form-control">
