               ...
               <ul class="sidebar-menu">
                  ...
                  <li class="treeview">
                     ...
                     <ul class="treeview-menu">
                        <li><a href="add-customer.html">Add Course</a></li>
                        <li><a href="clist.html">View Course</a></li>
                     </ul>
                  </li>
                  <li class="treeview">
                     <a href="#">
                     ...
                     <ul class="treeview-menu">
                        <li><a href="add-customer.html">Add New Exam</a></li>
                        <li><a href="expense.html">View Live Exams </a></li>
                     </ul>
                  </li>
                  <li class="treeview">
                     <a href="#">
                     ...
                     <ul class="treeview-menu">
                        <li><a href="invoice.html">Add Questions to Exam</a></li>
                        <li><a href="ninvoices.html">Questions View</a></li>
                     </ul>
                  </li>
                  <li class="treeview">
                     <a href="#">
