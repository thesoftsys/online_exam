            ...
            <div class="login-area">
                <div class="panel panel-bd panel-custom">
                    ...
                    <div class="panel-body">
                        <form action="code.php?flag=5" novalidate method="POST">
                            <div class="form-group">
                                <label class="control-label">UserID</label>
                                <input type="text" placeholder="example1234"  required=""  name="user_id"  class="form-control">
                                <span class="help-block small">Your unique userid to app</span>
                            </div>
                            <div class="form-group">
